...
@MainActor public struct RSSChannelListView: View {
    @Bindable private var viewModel: ObservableSwiftUIViewModelOf<RSSChannelListViewModel>
    
    public init(viewModel: any SwiftUIViewModelOf<RSSChannelListViewModel>) {
