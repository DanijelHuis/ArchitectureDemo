...
final class MockHTTPClient: HTTPClient {
    var buildRequestCalls = [(method: HTTPMethod, path: String?, query: [String : String]?, headers: [String : String]?, body: Data?)]()
    ...
    func buildRequest(method: HTTPMethod, path: String?, query: [String : String]?, headers: [String : String]?, body: Data?) async throws -> URLRequest {
        buildRequestCalls.append((method, path, query, headers, body))
